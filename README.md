...
This project is a store manager for a baseball merchandise store. I made a store to sell bats and jerseys for players. I made this because I am a big fan of baseball and I watch almost every dodger game. I used a no argument constructor, access modifiers, instance variables, and more. There is no user input for this project because it is already set to the jersey, bat, or bundle.